...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ubah Data Inspeksi</h1>
    </div>
            ...
            <form action="{{ url('/inspeksi') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select name="inspektor_id" class="form-control">
                        ...
                        @foreach ($inspektors as $inspektor)
                            <option value="{{ $inspektor->id }}" {{ old('inspektor_id') == $inspektor->id ? 'selected' : '' }}>
                                {{ $inspektor->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control" required>
                        @foreach (['pending', 'berjalan', 'selesai', 'dibatalkan'] as $val)
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="jadwal_inspeksi" class="form-control"
                        value="{{ old('jadwal_inspeksi') }}">
                </div>
