<?php
require_once __DIR__ . '../../layouts/headernl.php';
?>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                    <img src="../img/logo.png" height="30" width="50" alt="Logo TemuMobil">
                TemuMobil
            </a>
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav"
                ...
                <div class="d-flex gap-2">
                    <a href="../pages/login_regis/login/login.php" class="btn btn-login btn-custom">
                        <i class="fas fa-sign-in-alt me-1"></i>
                        Masuk
                    </a>
                    <a href="../pages/login_regis/regis/pilihanregis.php" class="btn btn-register btn-custom">
                ...
                <div class="col-lg-6">
                    <div class="hero-content">
                        ...
                        <div class="d-flex gap-3 flex-wrap">
                            <a href="/pages/login_regis/login/login.php" class="btn btn-primary btn-lg btn-custom">
                                <i class="fas fa-search me-2"></i>
                                Cari Mobil
                            </a>
                            <a href="/pages/login_regis/login/login.php" class="btn btn-outline-primary btn-lg btn-custom">
